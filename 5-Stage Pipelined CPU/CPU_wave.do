...
add wave -noupdate -group Flags /CPUstim/dut/FinalZero
add wave -noupdate -group Flags /CPUstim/dut/FinalNegative
add wave -noupdate -group Flags /CPUstim/dut/FinalCarry_Out
add wave -noupdate -group Flags /CPUstim/dut/FinalOverflow
...
add wave -noupdate -expand -group {Instruction and PC} -group {Ins and Op} /CPUstim/dut/bruh/instruction
add wave -noupdate -expand -group {Instruction and PC} -group {Ins and Op} /CPUstim/dut/bet/OpCode
add wave -noupdate -expand -group IF_ID -label IF_ID_ins /CPUstim/dut/ins/out
add wave -noupdate -expand -group ForwardMux -label ForwardRN -radix decimal /CPUstim/dut/Forward_Rn/out
add wave -noupdate -expand -group ForwardMux -label ForwardRm -radix decimal /CPUstim/dut/Forward_Rm/out
add wave -noupdate -expand -group ForwardMux -label Forward_Branch /CPUstim/dut/Forward_BRins/out
add wave -noupdate -expand -group ForwardMux -label STUR_Forward /CPUstim/dut/Forward_Stuse/out
...
add wave -noupdate -expand -group EX_MEM -label EX_MEM_Din -radix decimal /CPUstim/dut/EX_MEM_Din/out
add wave -noupdate -expand -group EX_MEM -label EX_MEM_ALUresult -radix decimal /CPUstim/dut/EX_MEM_ALU/out
add wave -noupdate -expand -group EX_MEM -label EX_MEM_Rd -radix unsigned /CPUstim/dut/EX_MEM_Rd/out
add wave -noupdate -expand -group EX_MEM -label EX_MEM_Link -radix unsigned /CPUstim/dut/EX_MEM_Link/q
add wave -noupdate -expand -group EX_MEM -label EX_MEM_MemTOReg -radix unsigned /CPUstim/dut/EX_MEM_MemToReg/q
add wave -noupdate -expand -group EX_MEM -label EX_MEM_MemWrite -radix unsigned /CPUstim/dut/EX_MEM_MemWrite/q
add wave -noupdate -expand -group EX_MEM -label EX_MEM_MemRead -radix unsigned /CPUstim/dut/EX_MEM_MemRead/q
add wave -noupdate -expand -group EX_MEM -label EX_MEM_PC4 -radix unsigned /CPUstim/dut/EX_MEM_PC4/out
add wave -noupdate -expand -group EX_MEM -label EX_MEM_RegWrite -radix unsigned /CPUstim/dut/EX_MEM_RegWrite/q
add wave -noupdate -expand -group MEM_WB -label MEM_WB_Memout -radix decimal /CPUstim/dut/MEM_WB_MEMout/out
add wave -noupdate -expand -group MEM_WB -label MEM_WB_ALUresult -radix decimal /CPUstim/dut/MEM_WB_ALUResult/out
add wave -noupdate -expand -group MEM_WB -label MEM_WB_Rd -radix unsigned /CPUstim/dut/MEM_WB_Rd/out
add wave -noupdate -expand -group MEM_WB -label MEM_WB_Link -radix unsigned /CPUstim/dut/MEM_WB_Link/q
add wave -noupdate -expand -group MEM_WB -label MEM_WB_MemToReg -radix unsigned /CPUstim/dut/MEM_WB_MemToReg/q
add wave -noupdate -expand -group MEM_WB -label MEM_WB_PC4 -radix unsigned /CPUstim/dut/MEM_WB_PC4/out
add wave -noupdate -expand -group MEM_WB -label MEM_WB_RegWrite -radix unsigned /CPUstim/dut/MEM_WB_RegWrite/q
add wave -noupdate -expand -group FinalStage -label BranchLinkMuxOut -radix decimal /CPUstim/dut/BranchLinkMUX/out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2751561713 ps} 1} {{Cursor 3} {2708898616 ps} 0}
...
update
WaveRestoreZoom {2392843428 ps} {2940208060 ps}
